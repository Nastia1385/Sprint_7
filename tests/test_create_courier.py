...
class TestCreateCourier:
    ...
    def test_create_courier_without_firstname_success(self, create_courier):
        courier_data = random_courier_data()
    ...
    def test_missing_required_fields(self, login, password, expected_error, create_courier):

        with allure.step(f"Создать курьера с логином='{login}' и паролем='{password}'"):
            response = create_courier(login, password, "Test")
